...
def process_input():
    if len(sys.argv) != 2 or len(sys.argv[1].split(".")) != 2:
        sys.exit("Please call this script passing exactly 1 argument (a path to a text file e.g. myfile.txt)!!!")
    else:
